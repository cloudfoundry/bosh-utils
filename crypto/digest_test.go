...
var _ = Describe("digestImpl", func() {
	Describe("Verify", func() {
		...
		Context("sha256", func() {
			Context("not yet prefixed with sha type", func() {
				BeforeEach(func() {
			...
			Context("already prefixed with sha type", func() {
				BeforeEach(func() {
					digest = NewDigest(DigestAlgorithmSHA256, "sha256:b94d27b9934d3e08a52e52d7da7dabfac484efe37a5380ee9088f7ace2efcde9")
				})
		...
		Context("sha512", func() {
			...
			Context("already prefixed with sha type", func() {
				BeforeEach(func() {
					digest = NewDigest(DigestAlgorithmSHA512, "sha512:309ecc489c12d6eb4cc40f50c902f2b4d0ed77ee511a7c7a9bcd3ca86d4cd86f989dd35bc5ff499670da34255b45b0cfd830e81f605dcf7dc5542e93ae9cd76f")
				})
	...
	Describe("String", func() {
		...
		Context("sha512", func() {
			...
			It("includes algorithm only once", func() {
				digest := NewDigest(DigestAlgorithmSHA512, "sha512:value")
				Expect(digest.String()).To(Equal("sha512:value"))
			})
		})
	})
