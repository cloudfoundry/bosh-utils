...
var _ = Describe("checksumVerifiableBlobstore", func() {
	...
	Describe("Create", func() {
		BeforeEach(func() {
			...
			fakeFile.Write([]byte("blargity-blarg-blarg")) //nolint:errcheck
		...
		It("delegates to inner blobstore to create blob and returns a multiple digest of returned blob", func() {
			...
			Expect(multipleDigest.String()).To(Equal("b7e2ed3ad48249425680c7bd3132d51c32116836;sha256:71abcee0cfc5832c30205dfcebfcceffc7d8996c4423116fa9c6da521518bcd6"))
		})
